...
void enter_test_input(double* ptr_data_input, struct parametrs* ptr_test_input, int length_data)
{
...
void enter_test_answer(double* ptr_data_answer, struct test_library* ptr_test_answer, int length_data)
{
    for(int i = 0; i < length_data; ++i)
    {
